...
class Storages::ProjectStoragesController < ApplicationController
  ...
  def ensure_folder_created
    ...
    folder_create_service.call(storage:, project_storages: project_storage_scope).on_failure do |result|
  ...
  def ensure_folder_permissions
    ...
    folder_permissions_service.call(storage:, project_storages: project_storage_scope).on_failure do |r|
